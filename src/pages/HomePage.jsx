...
function HomePage() {
  ...
  return (
    <div className="home-page">
        ...
        <p>Each guest is expected to arrive as their character on the evening (costumes and props is their own responsibility even though suggestions are provided)</p>
